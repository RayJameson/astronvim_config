...
return {
  ...
  keys = {
    ...
    { prefix .. "pl", "<cmd>Octo pr list<CR>", desc = "List open PRs" },
    ...
    { prefix .. "R1", "<cmd>Octo reaction thumbs_up<CR>", desc = "Add 👍 reaction" },
    { prefix .. "R2", "<cmd>Octo reaction thumbs_down<CR>", desc = "Add 👎 reaction" },
    { prefix .. "R3", "<cmd>Octo reaction eyes<CR>", desc = "Add 👀 reaction" },
    { prefix .. "R4", "<cmd>Octo reaction laugh<CR>", desc = "Add 😄 reaction" },
    { prefix .. "R5", "<cmd>Octo reaction confused<CR>", desc = "Add 😕 reaction" },
    { prefix .. "R6", "<cmd>Octo reaction rocket<CR>", desc = "Add 🚀 reaction" },
    { prefix .. "R7", "<cmd>Octo reaction heart<CR>", desc = "Add ❤️ reaction" },
    { prefix .. "R8", "<cmd>Octo reaction party<CR>", desc = "Add 🎉 reaction" },
